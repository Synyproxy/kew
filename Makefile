...
SRCS = src/common/appstate.c src/ui/common_ui.c src/common/common.c \
       ...
       src/sound/decoders.c src/sound/waveform.c src/sound/audio_file_info.c src/sound/playback.c src/sound/volume.c src/sound/video_ipc.c \
...
TEST_BINS = $(TEST_BIN_DIR)/test_video_ext $(TEST_BIN_DIR)/test_video_ipc
